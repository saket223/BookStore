...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1317e26c-d04d-405a-acde-e07acc1fb255
```

> `1317e26c-d04d-405a-acde-e07acc1fb255` is the password of the certificate, you can change it to any password you want.
